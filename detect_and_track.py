...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='inference/tracking/IR_DRONE_146.mp4', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--project', default='runs/tracking', help='save results to project/name')
    parser.add_argument('--name', default='Drone_tracking', help='save results to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    parser.add_argument('--no-trace', action='store_true', help='don`t trace model')
    parser.add_argument('--colored-trk', action='store_true', default=True, help='assign different color to every track')
